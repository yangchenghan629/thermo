...
a1=ax[0].contourf(time2,lev2,fb.T,cmap=cm.RdYlBu_r,extend='both',levels=np.linspace(-0.015,0.015,11))#
...
a2=ax[1].contourf(time2,lev2,fb.T,cmap=cm.RdYlBu_r,extend='both',levels=np.linspace(-0.015,0.015,11))#
xticks=np.arange(0,73,6)
xtexts=[f'{x/3:02.0f}'for x in xticks]
...
plt.tight_layout()
plt.savefig('buoyancy_contourf.png',dpi=600)